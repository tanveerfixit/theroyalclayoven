...
The Royal Clay Oven`);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20 space-y-12 animate-fade-in" id="booking-view">
      ...
      {!reservationsEnabled && (
        <div className="mb-6 border border-brand-accent/30 bg-brand-accent/5 p-3.5 text-left animate-fade-in" id="reservations-disabled-banner">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-3">
            <div className="space-y-0.5">
              <span className="font-mono text-[9px] text-brand-accent font-extrabold uppercase tracking-widest block">★ ONLINE RESERVATIONS PAUSED</span>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-brand-dark/70 backdrop-blur-sm animate-fade-in" id="reservations-disabled-modal">
          <div className="relative w-full max-w-sm sm:max-w-md bg-white border border-brand-dark p-5 sm:p-6 space-y-4 sm:space-y-5 shadow-[0_20px_50px_rgba(0,0,0,0.3)] animate-slide-up">
            ...
            <button
              ...
              className="absolute top-3 right-3 p-1 text-brand-dark hover:text-brand-dark hover:bg-brand-dark/5 transition-colors border border-transparent hover:border-brand-dark/10"
              aria-label="Close warning"
            >
              <X className="w-4 h-4" />
            </button>
            ...
            <div className="text-center space-y-3 pt-1">
              ...
              <p className="font-sans text-xs sm:text-sm text-brand-dark leading-relaxed font-medium text-center">
                {reservationsNoticeText}
              </p>
